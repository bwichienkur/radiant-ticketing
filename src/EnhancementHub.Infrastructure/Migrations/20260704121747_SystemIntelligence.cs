        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DbContextType = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceMember = table.Column<string>(type: "TEXT", nullable: true),
                    TableName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScanStatus = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ScanError = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnPremAgents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OnPremAgents_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemGraphSnapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SystemGraphSnapshots_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetDescription = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeReference = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    DatabaseReference = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchemaDriftReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SchemaDriftReports_DatabaseConnections_ConnectionId",
                        column: x => x.ConnectionId,
                        principalTable: "DatabaseConnections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SchemaDriftReports_Repositories_RepositoryId",
                        column: x => x.RepositoryId,
                        principalTable: "Repositories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeEntityMappings_RepositoryId",
                table: "CodeEntityMappings",
                column: "RepositoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CodeTableReferences_RepositoryId",
                table: "CodeTableReferences",
                column: "RepositoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnPremAgents_ApplicationId",
                table: "OnPremAgents",
                column: "ApplicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchemaDriftFindings_DatabaseConnectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchemaDriftReports_ConnectionId",
                table: "SchemaDriftReports",
                column: "ConnectionId");

            migrationBuilder.CreateIndex(
                name: "IX_SchemaDriftReports_RepositoryId",
                table: "SchemaDriftReports",
                column: "RepositoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SystemGraphEdges_SourceNodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemGraphNodes_ApplicationId_ReferenceKey",
                table: "SystemGraphNodes",
                columns: new[] { "ApplicationId", "ReferenceKey" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemGraphSnapshots_ApplicationId",
                table: "SystemGraphSnapshots",
                column: "ApplicationId");
        }
